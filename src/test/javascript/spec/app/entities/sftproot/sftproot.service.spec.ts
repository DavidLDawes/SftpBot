...
describe('Service Tests', () => {
    ...
    describe('Sftproot Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(SftprootService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/sftproots';
                expect(this.lastConnection.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return Sftproot', () => {

                let entity: Sftproot;
                service.find(123).subscribe((_entity: Sftproot) => {
                    entity = _entity;
                });
