package com.virtualsoundnw.sftpbot.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("sftpbot");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("sftpbot");
        ...
        config.getMapConfigs().put("com.virtualsoundnw.sftpbot.domain.*", initializeDomainMapConfig(jHipsterProperties));
